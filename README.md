...
For example here is how a Java primitive int (4 bytes, non-null) extra byte is defined.
...
For another example here is how a Java Integer (4 bytes, null able) extra byte is defined.
